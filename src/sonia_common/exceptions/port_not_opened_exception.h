...
#ifndef SONIA_COMMON_EXCEPTIONS_PORT_NOT_OPENED_EXCEPTION_H_
#define SONIA_COMMON_EXCEPTIONS_PORT_NOT_OPENED_EXCEPTION_H_
...
#endif  // SONIA_COMMON_EXCEPTIONS_PORT_NOT_OPENED_EXCEPTION_H_
